        ...
        implements ConnectorMetadata
{
    ...
    public ConnectorInsertTableHandle beginInsert(ConnectorSession session, ConnectorTableHandle tableHandle, List<ColumnHandle> columns, RetryMode retryMode)
    {
        ...
        List<SheetsColumnHandle> columnHandles = table.getColumnsMetadata().stream()
                .map(column -> new SheetsColumnHandle(column.getName(), column.getType(), counter.getAndIncrement()))
                .collect(toImmutableList());

        return new SheetsInsertTableHandle(sheetsTableHandle.getTableName(), columnHandles);
    }
